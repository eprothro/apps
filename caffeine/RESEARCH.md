...
- Lieberman 1987, _Psychopharmacology_: **32 / 64 / 128 / 256 mg** in adults. Vigilance and mood already up at **32 mg** (~0.46 mg/kg @70 kg). That is onset, not the 100–200 working dose.
- Lieberman 2002, men ~24: alerting in the ~100–200 mg adult range — most of the gain, not the first milligram.
- Cooper et al. 2021, adolescents 12–17, mean 15.1: **1 and 3 mg/kg** improved sustained attention. 1 mg/kg is a real youth mark.
...
**Model:** Hill, d50 ≈ 1.0–1.5, n ≈ 1.5. Same mg/kg at all ages. Card **from** is **0.5 mg/kg** (Lieberman 32), **to** is 180 mg @70 kg (plateau). Do not treat 100–200 mg as onset — that was the bug that made a 100 lb kid look asleep until ~60 mg.
...
**Model:** Steep Hill, **plateau by ~3**. 3 ≈ 6. Soft fade only after ~9 (no extra, not a crash). Same mg/kg all ages. Do not keep climbing 3→6. Card says improves **up to** 2–3 mg/kg (the top of the rise). **2 mg/kg is a model mark**, not a dose in Graham & Spriet (3/6/9) or Southward (3–6).
...
- Smit & Rogers 2000, _Psychopharmacology_: 12.5 / 25 / 50 / 100 mg. Mood and performance already moving at **25–50 mg** in low consumers (~0.4–0.7 mg/kg).
- Childs & de Wit 2006, _Psychopharmacology_, N=102 light users, 18–35 y: 50 / 150 / 450 mg. 150 ↑ positive mood / stimulated; 50 barely moved _their_ liking scales; 450 ↑ anxiety, less liking. Peak cheer is 150; onset on the pulse is earlier (Smit).
...
**Model:** pulse, rise 0.9, peak 2.2, **fall 1.0** so Griffiths 300 (~4.3) is actually gone, not 30% leftover. Same mg/kg all ages. Card onset **1.0 mg/kg** (Smit 50–70). Peak mark stays Childs 150.
...
**Youth:** no matched adolescent anxiety curve. Modest left-shift is **inferred** (kids are usually low-habitual), not measured. Mid 4.5 → 3.7 **and** steepness × 4.5/3.7 so the same words land at the same curve height.
...
**Model:** early steep Hill (on by 1, flat through 2) + later sigmoid (**mid 3.0 youth / 4.4 adult**) for ectopy so both ages read “extra beats pick up” at 0.5 of that step. No climb through 10 as if hemodynamics keep worsening.
...
| sleep                                                 | **same 0.28 mg/kg** remaining; half-life handles how fast you get there. No youth left-shift (Reichert 2021 null). |
...
`mg = landmark mg/kg × current kg`, rounded to 5. Adult-paper mg is stored as `studyMg / 70` unless the paper stated mass. Age stretches **anxiety** (× 3.7/4.5 if age < 18, plus matching steepness) and **heart** only. Half-life uses age. Quiet line is **0.28 mg/kg** remaining. Landolt’s “~25 mg left in ~70 kg men” stays a study fact and does not scale. Adult default weight is **154 lb** (~70 kg) so the quiet line prints ~20 mg and does not collide with that 25.
...
| anxiety     | 150 / 450 @70 kg; × 3.7/4.5 if age < 18 | Childs; Rogers                     |
...
**Alertness.** You feel more awake from about {from} mg, then extra dose adds little after about {to} mg. Higher dose does not make you less awake. — Lieberman 1987. Lieberman 2002, men ~24.

**Cognition.** Focus and reaction time get better from about {from} mg, best around {best} mg. By ~{memoryFail} mg, memory holds less — shorter digit spans — even though you still feel sharp. — Lieberman 1987. Childs & de Wit 2006, adults 18–35. Kaplan 1997.

**Endurance.** Aerobic work improves up to around {startLo}–{startHi} mg, then more dose does not buy more output. Same from {flatA} through {flatB} mg; {less} mg does not add more. — Graham & Spriet 1995, men ~20s. Southward 2018.
...
**Mood.** A bit more cheerful around {goodLo}–{goodHi} mg — a lift, not a rush. Around {turnDown} mg that lift is gone. By ~{tense} mg it is tense and not pleasant. — Smit & Rogers 2000. Childs & de Wit 2006. Griffiths, adults.

**Jitters.** A little shake starts around {little} mg. By ~{bigger} mg holding steady for something like threading a needle gets hard. — Richardson 1995, adults.

**Anxiety.** Tension shows up around {some} mg in some people, not most. By ~{most} mg most people get tense. — Childs & de Wit 2006. Rogers 2010, adults.
...
**Uptake.** Most of it takes effect within 45 minutes. Peaks around {peak} minutes. A meal can add an hour. Tmax is ~50 min at 13 and ~52 adult; both round to 50. Do not say “at this age.” — Bonati 1982. Liguori 1997. Brachtel 1988.
